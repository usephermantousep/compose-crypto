...
import com.plcoding.cryptocurrencyappyt.presentation.coint_detail.CoinDetailScreen
            ...
            CryptocurrencyAppYTTheme(true) {
                Surface(color = MaterialTheme.colors.background) {
                    ...
                    NavHost(
                        ...
                        composable(
                            route =  "${Screen.CoinDetailcreen.route}/{coinId}"
                        ){
                            CoinDetailScreen()
                        }
                    }
